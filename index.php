...
<div class="wait overlay">
	...
	<div class="navbar navbar-inverse navbar-fixed-top navbar-primary bg-primary">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav ">
				<li><a href="index.php"><span class="glyphicon glyphicon-home text-warning font-weight-bold"></span> Home</a></li>
...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<footer>
        <h2 class="p-4 bg-primary text-white text-center"><br>Best Online Shopping Site</h2>
    </footer>
</body>
</html>
